...
class PasswordView extends React.Component {
  ...
  sendcode = (e) => {
    e.preventDefault();
     this.props.actions.sendCodes(this.state.username)
        .catch((error) => {
    ...
    change(event, stateName, type, stateNameEqualTo) {
      ...
      register = (e) => {
        e.preventDefault();
        return this.props.actions.registerUser(this.state.username, this.state.code, this.state.password, this.state.redirectTo)
            .catch((error) => {
                console.log(error);
            })
    };
                  ...
                  <CardBody>
                    <GridContainer justify="center">
                      ...
                      <GridItem xs={12} sm={5} md={5}>
                        ...
                        inputProps={{
                            onChange: event => this.change(event, "username","phone"),
                          placeholder: "Phone...",
                          type: "phone",
                          startAdornment: (
